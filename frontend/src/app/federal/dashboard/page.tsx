            ...
            <Card key={index} className="hover:shadow-lg transition-shadow">
              <CardBody>
                <div className="flex items-start justify-between">
                  ...
                  <div className="p-3 bg-federal-gold/10 rounded-lg text-federal-gold">
                    {stat.icon}
                  </div>
                </div>
              </CardBody>
            ...
            <CardBody>
              <div className="space-y-4">
                {recentActivities.map((activity) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-federal-gold/10 flex items-center justify-center">
                      {activity.type === 'application' && (
                        <svg className="w-5 h-5 text-federal-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                      )}
