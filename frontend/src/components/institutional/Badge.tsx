...
const colorVariants = {
  ...
  primary: {
    solid: 'bg-institutional-burgundy text-white',
    flat: 'bg-institutional-burgundy/10 text-institutional-burgundy',
    bordered: 'bg-transparent text-institutional-burgundy border-institutional-burgundy',
    dot: 'bg-institutional-burgundy',
  },
  secondary: {
    solid: 'bg-institutional-gold text-white',
    flat: 'bg-institutional-gold/10 text-institutional-gold',
    bordered: 'bg-transparent text-institutional-gold border-institutional-gold',
    dot: 'bg-institutional-gold',
  },
  success: {
