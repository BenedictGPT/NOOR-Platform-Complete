          ...
          {options.map((option, index) => (
            <li
              ...
              className={`
                ...
                ${option.value === currentValue ? 'bg-individual-royal/10 text-individual-royal font-medium' : 'text-gray-900'}
            ...
            >
              <div className="flex items-center justify-between">
                ...
                {option.value === currentValue && (
                  <svg className="w-5 h-5 text-individual-royal" fill="currentColor" viewBox="0 0 20 20">
