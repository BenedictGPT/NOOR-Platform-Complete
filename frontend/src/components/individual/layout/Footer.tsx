        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h3 className="text-lg font-bold font-cairo">NOOR Platform</h3>
                <p className="text-sm text-gray-300 font-noto">
                  National Opportunities Optimization & Realization
                </p>
              </div>
            </div>
            <p className="text-sm text-gray-300 leading-relaxed">
              Empowering UAE citizens and optimizing national workforce through AI-driven
              opportunity matching and comprehensive skills development.
            </p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-300">
              © {currentYear} UAE Individual Citizens. All rights reserved.
            </p>
